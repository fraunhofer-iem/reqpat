...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Incoming Information Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.fraunhofer.iem.reqpat.demo.model.impl.IncomingInformationDefinitionImpl#getFunctionalDevice <em>Functional Device</em>}</li>
 *   <li>{@link de.fraunhofer.iem.reqpat.demo.model.impl.IncomingInformationDefinitionImpl#getAnalysisFunction <em>Analysis Function</em>}</li>
 *   <li>{@link de.fraunhofer.iem.reqpat.demo.model.impl.IncomingInformationDefinitionImpl#getInformationList <em>Information List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IncomingInformationDefinitionImpl extends RequirementPatternImpl implements IncomingInformationDefinition {
	/**
	 ...
	 * @generated
	 */
	protected IncomingInformationDefinitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DemoModelPackage.Literals.INCOMING_INFORMATION_DEFINITION;
	}
		...
		if (functionalDevice != null && functionalDevice.eIsProxy()) {
			...
			if (functionalDevice != oldFunctionalDevice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DemoModelPackage.INCOMING_INFORMATION_DEFINITION__FUNCTIONAL_DEVICE, oldFunctionalDevice, functionalDevice));
			}
		}
	...
	public void setFunctionalDevice(FunctionalDevice newFunctionalDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoModelPackage.INCOMING_INFORMATION_DEFINITION__FUNCTIONAL_DEVICE, oldFunctionalDevice, functionalDevice));
	}
	...
	public AnalysisFunction getAnalysisFunction() {
		if (analysisFunction != null && analysisFunction.eIsProxy()) {
			...
			if (analysisFunction != oldAnalysisFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DemoModelPackage.INCOMING_INFORMATION_DEFINITION__ANALYSIS_FUNCTION, oldAnalysisFunction, analysisFunction));
			}
		}
	...
	public void setAnalysisFunction(AnalysisFunction newAnalysisFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoModelPackage.INCOMING_INFORMATION_DEFINITION__ANALYSIS_FUNCTION, oldAnalysisFunction, analysisFunction));
	}
	...
	public EList<Information> getInformationList() {
		if (informationList == null) {
			informationList = new EObjectContainmentEList<Information>(Information.class, this, DemoModelPackage.INCOMING_INFORMATION_DEFINITION__INFORMATION_LIST);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DemoModelPackage.INCOMING_INFORMATION_DEFINITION__INFORMATION_LIST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DemoModelPackage.INCOMING_INFORMATION_DEFINITION__FUNCTIONAL_DEVICE:
				if (resolve) return getFunctionalDevice();
				return basicGetFunctionalDevice();
			case DemoModelPackage.INCOMING_INFORMATION_DEFINITION__ANALYSIS_FUNCTION:
...
} //IncomingInformationDefinitionImpl

 ...
 * @generated
 */
public class EmbeddedXtextEditorSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public EmbeddedXtextEditorSwitch() {
	 ...
	 * @generated
	 */
	public T caseEmbeddedXtextEditorConfiguration(
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EmbeddedXtextEditorPackage.EMBEDDED_XTEXT_EDITOR_CONFIGURATION: {
			EmbeddedXtextEditorConfiguration embeddedXtextEditorConfiguration = (EmbeddedXtextEditorConfiguration) theEObject;
			T result = caseEmbeddedXtextEditorConfiguration(embeddedXtextEditorConfiguration);
			if (result == null)
				result = caseProrPresentationConfiguration(embeddedXtextEditorConfiguration);
			if (result == null)

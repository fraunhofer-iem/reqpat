 ...
 * @generated
 */
public class ImagePresentationServiceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ImagePresentationServiceSwitch() {
	 ...
	 * @generated
	 */
	public T caseImagePresentationServiceConfiguration(
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ImagePresentationServicePackage.IMAGE_PRESENTATION_SERVICE_CONFIGURATION: {
			ImagePresentationServiceConfiguration imagePresentationServiceConfiguration = (ImagePresentationServiceConfiguration) theEObject;
			T result = caseImagePresentationServiceConfiguration(imagePresentationServiceConfiguration);
			if (result == null)
				result = caseProrPresentationConfiguration(imagePresentationServiceConfiguration);
			if (result == null)
...
} // ImagePresentationServiceSwitch

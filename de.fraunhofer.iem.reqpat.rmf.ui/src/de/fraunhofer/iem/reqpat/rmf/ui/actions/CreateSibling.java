 ...
 * 
 */
public abstract class CreateSibling implements IEditorActionDelegate {
	...
	protected abstract void insertNewSibling(SpecHierarchy specHierarchy);

	/**
	 * Copied from
	 * org.eclipse.rmf.pror.reqif10.editor.agilegrid.ProrAgileGridViewer and
	 * adjusted to the new environment.
	 */
	protected void insertNewSibling(SpecHierarchy specHierarchy, String typeName) {
		if (editor == null)
			return;

...
public class InternalReqPatDemoLexer extends Lexer {
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:19:7: ( ':' )
            // InternalReqPatDemo.g:19:9: ':'
            {
            match(':'); 
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:20:7: ( 'from the functional device' )
            // InternalReqPatDemo.g:20:9: 'from the functional device'
            {
    ...
    public final void mRULE_PARAMDELIMITERLEFT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4761:25: ( '[' )
            // InternalReqPatDemo.g:4761:27: '['
            {
            match('['); 
    ...
    public final void mRULE_PARAMDELIMITERRIGHT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4763:26: ( ']' )
            // InternalReqPatDemo.g:4763:28: ']'
            {
            match(']'); 
    ...
    public final void mRULE_SPECOBJECTDELIMITERLEFT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4765:30: ( '{' )
            // InternalReqPatDemo.g:4765:32: '{'
            {
            match('{'); 
    ...
    public final void mRULE_SPECOBJECTDELIMITERRIGHT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4767:31: ( '}' )
            // InternalReqPatDemo.g:4767:33: '}'
            {
            match('}'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4769:9: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )* )
            // InternalReqPatDemo.g:4769:11: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            {
            ...
            // InternalReqPatDemo.g:4769:31: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4771:10: ( ( '0' .. '9' )+ )
            // InternalReqPatDemo.g:4771:12: ( '0' .. '9' )+
            {
            // InternalReqPatDemo.g:4771:12: ( '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalReqPatDemo.g:4771:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4773:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalReqPatDemo.g:4773:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalReqPatDemo.g:4773:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalReqPatDemo.g:4773:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalReqPatDemo.g:4773:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop3:
                    do {
                        int alt3=3;
                    ...
                    break;
                case 2 :
                    // InternalReqPatDemo.g:4773:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalReqPatDemo.g:4773:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4775:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalReqPatDemo.g:4775:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalReqPatDemo.g:4775:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4777:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalReqPatDemo.g:4777:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalReqPatDemo.g:4777:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
            ...
            // InternalReqPatDemo.g:4777:40: ( ( '\\r' )? '\\n' )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalReqPatDemo.g:4777:41: ( '\\r' )? '\\n'
                    {
                    // InternalReqPatDemo.g:4777:41: ( '\\r' )?
                    int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4779:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalReqPatDemo.g:4779:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalReqPatDemo.g:4779:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReqPatDemo.g:4781:16: ( . )
            // InternalReqPatDemo.g:4781:18: .
            {
            matchAny(); 
    ...
    static final String DFA11_eotS =
        "\2\uffff\3\31\1\uffff\1\31\1\uffff\1\31\1\40\1\31\1\42\6\uffff\3\26\3\uffff\1\31\1\uffff\2\31\1\uffff\1\31\1\uffff\1\31\1\uffff\1\61\12\uffff\2\31\1\uffff\1\31\11\uffff\1\31\12\uffff\1\106\2\uffff";
    static final String DFA11_eofS =
        "\107\uffff";
    static final String DFA11_minS =
        "\1\0\1\uffff\1\150\1\141\1\163\1\uffff\1\162\1\uffff\1\157\1\55\1\120\1\55\6\uffff\2\0\1\52\3\uffff\1\145\1\uffff\1\163\1\40\1\uffff\1\157\1\uffff\1\40\1\uffff\1\55\12\uffff\2\40\1\141\1\155\2\uffff\1\146\6\uffff\1\40\1\157\2\uffff\1\156\1\uffff\1\143\1\164\1\151\1\157\1\156\1\141\2\uffff";
    static final String DFA11_maxS =
        "\1\uffff\1\uffff\1\150\1\141\1\163\1\uffff\1\162\1\uffff\1\157\1\172\1\120\1\172\6\uffff\2\uffff\1\57\3\uffff\1\145\1\uffff\1\163\1\40\1\uffff\1\157\1\uffff\1\40\1\uffff\1\172\12\uffff\2\40\1\165\1\155\2\uffff\1\164\6\uffff\1\40\1\165\2\uffff\1\156\1\uffff\1\143\1\164\1\151\1\157\1\156\1\141\2\uffff";
    static final String DFA11_acceptS =
        "\1\uffff\1\1\3\uffff\1\11\1\uffff\1\13\4\uffff\1\23\1\24\1\25\1\26\1\27\1\30\3\uffff\1\34\1\35\1\1\1\uffff\1\27\2\uffff\1\11\1\uffff\1\13\1\uffff\1\20\1\uffff\1\22\1\23\1\24\1\25\1\26\1\30\1\31\1\32\1\33\1\34\4\uffff\1\15\1\21\1\uffff\1\5\1\7\1\10\1\14\1\16\1\17\2\uffff\1\4\1\12\1\uffff\1\3\6\uffff\1\6\1\2";
    static final String DFA11_specialS =
        "\1\2\21\uffff\1\0\1\1\63\uffff}>";
    static final String[] DFA11_transitionS = {
            "\11\26\2\25\2\26\1\25\22\26\1\25\1\26\1\22\4\26\1\23\4\26\1\7\1\26\1\1\1\24\12\21\1\5\6\26\5\20\1\13\1\20\1\11\11\20\1\12\1\20\1\2\6\20\1\14\1\26\1\15\3\26\5\20\1\6\1\20\1\3\1\4\12\20\1\10\6\20\1\16\1\26\1\17\uff82\26",
            "",
            "\1\30",
            "\1\32",
            "\1\33",

 ...
 * @generated
 */
public class HeadlinePresentationServiceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HeadlinePresentationServiceSwitch() {
	 ...
	 * @generated
	 */
	public T caseHeadlinePresentationServiceConfiguration(
	 ...
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '
	 *         <em>Pror Presentation Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProrPresentationConfiguration(
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HeadlinePresentationServicePackage.HEADLINE_PRESENTATION_SERVICE_CONFIGURATION: {
			HeadlinePresentationServiceConfiguration headlinePresentationServiceConfiguration = (HeadlinePresentationServiceConfiguration) theEObject;
			T result = caseHeadlinePresentationServiceConfiguration(headlinePresentationServiceConfiguration);
			if (result == null)
				result = caseProrPresentationConfiguration(headlinePresentationServiceConfiguration);
			if (result == null)
...
} // HeadlinePresentationServiceSwitch
